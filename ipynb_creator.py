...
# TODO: Pass filename via command line parameters.
# E.g. $ ipynb_creator -i file.py OR $ ipynb_creator -i file.txt
#
import sys
import os
try:
...
if __name__ == "__main__":
    ...
    print("\nipynb_creator version: {}".format(VERSION))
...
HELP_FULL = """Usage: ipynb_creator [OPTION]... [FILE]...
...
HELP_BRIEF = """Usage: ipynb_creator [OPTION]... [FILE]...
Create Jupyter notebook ipynb file(s) upon having been supplied python (.py) or 
text (.txt) file(s)
